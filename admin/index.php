      ...
      <div class="container mt-5">
        <div class="container text-center">
          <div class="row row-cols-5">
            <a href="doctor.php" class="col btn btn-dark m-2 py-3">
              <i class="fa fa-user-md fs-1" aria-hidden="true"></i><br>
              Doctors
            </a>
            <a href="patient.php" class="col btn btn-dark m-2 py-3">
              <i class="fa fa-user fs-1" aria-hidden="true"></i><br>
              Patients
            </a>


            <a href="contact.php" class="col btn btn-dark m-2 py-3">
            ...
            <!-- <a href="" class="col btn btn-primary m-2 py-3 col-5">
               ...
               <a href="drugs.php" class="col btn btn-dark m-2 py-3">
